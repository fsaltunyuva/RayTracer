...
public:
    ...
    Vec3 motionBlur; // for motion blur (only translational movements)

    vector<int> textureMapIds;
};
...
public:
    ...
    // Offsets for global vertex and texture coordinate arrays
    int vertexOffset = 0;
    int textureOffset = 0;
};
...
public:
    ...
    vector<LightSphere> lightSpheres;
    vector<LightMesh> lightMeshes;
};
